 ...
 */
final class Version20180720083602 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_16DB4F89A5BC2E0E ON picture (trip_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_16DB4F89A5BC2E0E ON picture');
